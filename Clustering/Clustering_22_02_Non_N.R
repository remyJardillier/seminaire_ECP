...
plot(clust_h, xlab=NULL, sub=NULL, labels = FALSE)
...
plot(dtm1, terms = findFreqTerms(dtm1,lowfreq = 150), corThreshold = 0.6)
...
plot(dtm2, 
     terms = findFreqTerms(dtm2,lowfreq = 150),
     corThreshold = 0.6)
